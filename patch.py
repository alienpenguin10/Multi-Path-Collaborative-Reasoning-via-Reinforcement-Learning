...
"""
The custom patch groups thinking_residual_gate_* and thinking_residual_Lambda params
with separate LRs so the gate can warm up gradually as described in the paper's progressive hybridization schedule.
"""
