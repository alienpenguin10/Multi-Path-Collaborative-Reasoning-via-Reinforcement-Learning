...
class TransformersKwargs(TypedDict, total=False):
    ...
    Attributes:
        ...
        num_logits_to_keep (`int`, *optional*):
            Number of logits to keep (unsloth optimization).
        logits_to_keep (`int`, *optional*):
            Deprecated alias for num_logits_to_keep.
    """
    m3po_enabled: Optional[bool]
    m3po_n_paths: Optional[int]
    m3po_temperature: Optional[float]
    m3po_force_training_mode: Optional[bool]
    ...
    num_logits_to_keep: Optional[int]  # unsloth optimization parameter
    logits_to_keep: Optional[int]  # unsloth optimization parameter (deprecated)
