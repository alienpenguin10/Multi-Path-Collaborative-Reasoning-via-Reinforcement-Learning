...
class GRPOTrainer(BaseTrainer):
    ...
    def __init__(
        ...
        self.return_thinking_embeds = args.return_thinking_embeds
    ...
    def _generate_single_turn(self, prompts: list[str], images: Optional[list]):
        ...
        if self.use_vllm:
            ...
            """
            VARNIE LEARNING: This is what ever that is not VLLM or PAGED    
            """
            ...
            with (
                ...
                prompt_completion_ids, thinking_embeds, thinking_mask, embeds_ratio = unwrapped_model.generate(
                    **generate_inputs,
                    ...
                    return_thinking_embeds=self.return_thinking_embeds,
                    enable_cross_path=self.enable_cross_path, #NOTE: M3PO Enable 
                    cross_path_lambda=self.cross_path_lambda, #NOTE: M3PO blending coefficient
                    cross_path_temp=self.cross_path_temp, #NOTE: M3PO temperature
